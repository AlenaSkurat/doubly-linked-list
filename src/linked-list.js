/*
    #reverse
      6) should reverse the list
    #indexOf
      7) should return index of element if data is found
      8) should return -1 if data not found
    chaining
      9) append reverse deleteAt insertAt methods should be chainable
*/
